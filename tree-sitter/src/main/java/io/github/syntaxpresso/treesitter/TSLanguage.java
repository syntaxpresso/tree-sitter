...
public abstract class TSLanguage {
  ...
  /**
   * Get the ABI version number for this language. This version number is used to ensure that
   * languages were generated by a compatible version of Tree-sitter.<br>
  ...
  /**
   * Get the ABI version number for this language. This version number is used to ensure that
   * languages were generated by a compatible version of Tree-sitter.
   *
   * @return ABI version.
   */
  ...
  /**
   * Get the metadata for this language. This information is generated by the CLI, and relies on the
   * language author providing the correct metadata in the language's `tree-sitter.json` file.
   *
  ...
  /**
   * Check whether the given node type id belongs to named nodes, anonymous nodes, or a hidden
   * nodes.<br>
   ...
   * suggestions or valid symbols in error nodes. Use {@link TSNode#getGrammarSymbol()} for valid
   * symbols.
   *
